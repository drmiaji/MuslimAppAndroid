...
class DynamicAdapter2(private var datalist: List<Any>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == HEADER_TYPE) {
            ...
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.task_layout2, parent, false)
